...
frontend/         Next.js (App Router, TypeScript, Tailwind)
  src/app/        pages: practice, the dashboard, setup, and the pattern book, which shows the
                  design system
  ...
  src/lib/        API address and errors, theme, grades and drafts, interview mode, what practice
                  earned, the level-up burst, and the glyph pictures' engine and grids
